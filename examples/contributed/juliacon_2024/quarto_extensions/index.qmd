...
Find the presentation slides below or click [here](presentation.qmd){target="_blank"} to view the slides in a new tab.

For the PDF version, click [here](presentation.pdf){target="_blank"}.
