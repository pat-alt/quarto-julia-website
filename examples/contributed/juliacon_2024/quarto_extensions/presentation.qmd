...
format: #specify to render to md
  commonmark:
...
Use the <br>[Quarto VS Code extension](https://marketplace.visualstudio.com/items?itemName=quarto.quarto) <br> and `Quarto Preview`
