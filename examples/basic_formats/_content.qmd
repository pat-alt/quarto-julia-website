...
1. The [JuliaMono](https://juliamono.netlify.app/) font, which by default is used for code.
2. The [Barlow](https://tribby.com/fonts/barlow/) font, which is used as the default font for everything else.
